...
MSMS_SPECTRUM_FUNCTION = CFUNCTYPE(
    None, c_int64, c_uint32, POINTER(c_double), POINTER(c_float), POINTER(c_void_p)
)

MSMS_PROFILE_SPECTRUM_FUNCTION = CFUNCTYPE(
    None, c_int64, c_uint32, POINTER(c_int32), POINTER(c_void_p)
)
...
class TimsVisLine(Structure):
    ...
    _fields_ = [("x0", c_int32), ("y0", c_int32), ("x1", c_int32), ("y1", c_int32)]
